...
import SummaryWidget from "@/app/dashboard/components/widgets/SummaryWidget";
import PropertyClassPieChart from "@/app/dashboard/components/widgets/PropertyClassPieChart";
import GeolocationWidget from "@/app/dashboard/components/widgets/GeolocationWidget";
import DataTableWidget from "@/app/dashboard/components/widgets/DataTableWidget";
import TrendsWidget from "@/app/dashboard/components/widgets/TrendsWidget";
...
const initialLayout: LayoutItem[] = [
  {
    ...
    minH: 8, // Ensure minimum height is sufficient
    minW: 6,
